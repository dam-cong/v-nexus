...
| 2026-07-18 15:20 | Hiến | Claude Code | Đổi tên hiển thị dự án từ "V-Nexus Tutor" thành "V-NEXUS SCHOOL: AI-powered Adaptive Learning Platform" theo `docs/plan-rename-brand.md` — chỉ đổi title/header/logo UI và tiêu đề các file docs, không đụng định danh hạ tầng (DB, docker, git remote, class Python, email domain demo) | Sửa `frontend/index.html`, `Login.jsx`, `StudentSurvey.jsx`, `App.jsx`, 5 file mockup `docs/danh-gia/code-0{1,3,4,5,6}.html`, và tiêu đề các file docs (README, PROJECT_DESCRIPTION, PLAN, timeline, ai-danh-gia, PHAN_TICH_DE_ADAPTIVE_TUTORING, DESIGN, RULES). Giữ nguyên các dòng log lịch sử phía trên (13, 16) vì đó là bản ghi đúng thời điểm, không sửa lại quá khứ — Chưa commit | Hiến |
