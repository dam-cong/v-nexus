...
- Học sinh phổ thông, đặc biệt ở lớp học có chênh lệch nền tảng lớn và điều kiện mạng
  không ổn định.
- Giáo viên cần theo dõi lớp đông, phát hiện nhu cầu cá nhân/nhóm và ưu tiên hỗ trợ.
...
- Môn Toán.
- Tập trung lớp 6–7 và cho phép truy ngược kiến thức tiên quyết từ lớp 5.
- Mạch minh họa: **Phân số → Tỉ lệ/Phần trăm → Biểu thức/Phương trình**.
...
- **Chưa được chứng minh là đã hoàn thành:** Knowledge Graph, ngân hàng câu hỏi Toán,
...
Trong một lớp phổ thông khoảng 40 học sinh, các em có thể đang học cùng một bài nhưng
có nền tảng rất khác nhau. Một lỗi ở bài Toán lớp 7 có thể không xuất phát từ nội dung
đang học mà từ kỹ năng phân số, quy đồng hoặc phép tính đã hổng từ lớp 5–6. Điểm tổng
kết hoặc nhãn đúng/sai không chỉ ra được nguyên nhân này.
...
Học sinh cần biết mình đang vướng ở kỹ năng nào, vì sao cần học lại một phần kiến thức
nền và bước tiếp theo là gì. Các em có thể làm bài chẩn đoán, theo lộ trình cá nhân,
nhận phản hồi, xem tiến độ của chính mình và tiếp tục học khi mạng yếu. Học sinh không
được xem dữ liệu, thứ hạng ưu tiên hay lỗ hổng của học sinh khác.

### 4.2. Giáo viên

Giáo viên cần nhìn được cả lớp và từng học sinh mà không phải tự tổng hợp mọi bài làm.
Giáo viên giao bài, xem bằng chứng chẩn đoán, điều chỉnh nhóm, giao bài bổ sung, ghi
nhận can thiệp, đánh dấu khuyến nghị chưa chính xác và theo dõi kết quả sau hỗ trợ.
...
1. Tạo môn Toán, các khối 5–7 và các chủ đề trong phạm vi MVP.
...
4. Thiết lập quan hệ tiên quyết, cho phép kỹ năng lớp 7 phụ thuộc kỹ năng lớp 5 hoặc 6.
...
1. Một học sinh lớp 7 làm sai bài phương trình có phân số.
2. Hệ thống xác định giải phương trình là target skill cần kiểm tra.
3. Hệ thống tiếp tục kiểm tra phép tính phân số và kỹ năng quy đồng liên quan.
4. Bằng chứng cho thấy học sinh chưa vững quy đồng phân số từ lớp dưới; đây là
   root-cause skill được đề xuất.
5. Hệ thống tạo lộ trình: **quy đồng → phép tính phân số → phương trình** và bỏ qua phần
...
8. Giáo viên thấy học sinh trong nhóm cần hỗ trợ về phân số, cùng bằng chứng và lý do
   ưu tiên nếu có.
...
- Dữ liệu chương trình Toán lớp 5–7 trong mạch demo và mapping yêu cầu cần đạt GDPT
  2018.
...
- Chỉ minh họa môn Toán trong một mạch kiến thức hẹp của lớp 6–7, truy ngược lớp 5;
  chưa đại diện cho toàn bộ GDPT 2018.
...
- Mở rộng Knowledge Graph sang nhiều mạch Toán, nhiều khối và nhiều môn.
...
- Xem xét Tiếng Anh K–12, placement test bốn kỹ năng, ASR/chấm nói và phân tích CV như
  các sản phẩm/phân hệ tương lai; không trộn chúng vào MVP Toán.
